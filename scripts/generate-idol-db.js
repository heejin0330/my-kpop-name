// CSV 데이터를 직접 파싱하여 IDOL_DB 형식으로 변환
...
const surnameMap = {
  ...
  '니차': 'Nicha', '와타나베': 'Watanabe', '변': 'Byun', '도': 'Do', '오': 'Oh',
  '저우': 'Zhou', '히라이': 'Hirai', '묘이': 'Moi', '미나토자키': 'Minatozaki',
  '투안': 'Tuan', '뱀뱀': 'BamBam', '왕': 'Wang', '마쉬': 'Marsh', '폰데차피팟': 'Pondecha',
  '분팍디트라웰': 'Bunphak', '마노반': 'Manoban', '다우마': 'Dauma', '에닉': 'Ennik'
};
...
function extractSurname(realName) {
  ...
  if (englishMatch) {
    ...
    const reverseMap = {
      ...
      'Dauma': '다우마', 'Ennik': '에닉', 'Zhou': '저우', 'Hirai': '히라이',
      'Moi': '묘이', 'Minatozaki': '미나토자키', 'Byun': '변', 'Do': '도', 'Oh': '오'
    };
